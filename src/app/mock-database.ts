...
export const ALBUMS: Album[] = [
 new Album("Pulsesssss", "Pink Floyd", "A live  album by the English progressive rock band originally released in 1995, on the label EMI in the United Kingdom.", 1),
